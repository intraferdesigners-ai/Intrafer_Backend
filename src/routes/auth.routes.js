...
const { register, login, sendOTP, verifyOTP, refreshToken, logout, getMe, updateProfile, forgotPassword, resetPassword, getSavedVendors, saveVendor, unsaveVendor } = require('../controllers/auth.controller');
